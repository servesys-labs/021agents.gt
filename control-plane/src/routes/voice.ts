...
voiceRoutes.openapi(listVoicesRoute, async (c): Promise<any> => {
  ...
  const voices: Record<string, { id: string; name: string; language: string }[]> = {
    kokoro: [
      ...
      { id: "jf_gongitsune", name: "Gongitsune (Female)", language: "ja" },
      { id: "jm_kumo", name: "Kumo (Male)", language: "ja" },
      { id: "zf_xiaobei", name: "Xiaobei (Female)", language: "zh" },
      { id: "zf_xiaoni", name: "Xiaoni (Female)", language: "zh" },
      { id: "zf_xiaoxiao", name: "Xiaoxiao (Female)", language: "zh" },
      { id: "zm_yunjian", name: "Yunjian (Male)", language: "zh" },
      { id: "zm_yunxi", name: "Yunxi (Male)", language: "zh" },
      { id: "ef_dora", name: "Dora (Female)", language: "es" },
      { id: "em_alex", name: "Alex (Male)", language: "es" },
