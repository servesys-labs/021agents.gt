---
name: wf-improve
description: Run analyze_and_suggest and apply AI-generated improvement suggestions. Phase 7.4 extraction — use {{AGENT_NAME}} placeholder for template values.
scope: meta
---
### "Improve my agent"
