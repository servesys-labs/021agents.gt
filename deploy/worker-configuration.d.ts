/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0f4e9e46aef3e5f7eafdb3674b5e96b5)
// Runtime types generated with workerd@1.20260401.1 2026-03-01 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		AGENT_RUN_WORKFLOW: Workflow<Parameters<import("./src/index").AgentRunWorkflow['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DEFAULT_PLAN" | "DEFAULT_PROVIDER" | "DEFAULT_MODEL" | "CONTROL_PLANE_URL" | "LOCAL_SEARCH_URL" | "OCR_ENDPOINT_URL" | "PDF_RENDER_URL" | "EMBEDDING_URL" | "RERANKER_URL" | "CF_EXEC_POOL_SIZE" | "CF_EXEC_LEASE_MS" | "CF_EXEC_WAIT_MS">> {}
}
